  ...
  <header class="site-header">
    <div class="container">
      ...
      <div class="header-actions">
        ...
        <a href="../../index.php" class="btn btn-gradient btn-sm">Sair</a>
      </div>
    </div>
  </header>
  ...
  <main class="container" style="flex:1;">
    ...
    <section class="tab-panel" id="tab-rendimento">
      ...
      <div class="chart-card">
        ...
        <div class="chart-wrap" style="display:flex; align-items:center; justify-content:center; color:var(--ink-soft); font-weight:700;">
